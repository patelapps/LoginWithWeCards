...
class urls {
    ...
    public static final String LIVE_URL = "https://www.we.cards/wecards/api/";
    public static final String LIVE_DEV_URL = "http://mmc-apps.com/dev/wecards/api/";
    public static final String MMC_LIVE_URL = "http://mmc-apps.com/wecards/api/";
